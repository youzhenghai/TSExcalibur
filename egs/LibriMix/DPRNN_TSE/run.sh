...
CUDA_VISIBLE_DEVICES=2,4,5 python train.py

CUDA_VISIBLE_DEVICES=5 python eval.py --test_dir data/wav8k/min/test --task sep_noisy --model_path exp/tmp/best_model.pth --out_dir exp/tmp/out_best --exp_dir exp/tmp --use_gpu=1
